    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.img_backarrow:
                ...
                Intent i = new Intent(AuctionActivity.this, MainActivity.class);
                startActivity(i);
...
//                fragmentManager1.beginTransaction().replace(R.id.activity_main_content_fragment, fragment_privacy).commit();
    ...
    public void dialog_pricebids() {
                ...
                dialog = new Dialog(AuctionActivity.this, android.R.style.Theme_Translucent) {
            @Override
    ...
    public void dialog_quesans() {
        ...
        dialog1 = new Dialog(AuctionActivity.this, android.R.style.Theme_Translucent) {
            @Override
            public boolean onTouchEvent(MotionEvent event) {
                // Tap anywhere to close dialog.
                dialog1.dismiss();
